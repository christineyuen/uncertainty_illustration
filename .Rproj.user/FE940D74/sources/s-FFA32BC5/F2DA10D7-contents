...
# [TODO] seems when there is only one comparing method, it is not shown in the graph

CSUV::interactive.uncertainty.illustration()

# library(devtools)
# install_github("christineyuen/CSUV", force = TRUE)
# detach("package:CSUV", unload=TRUE)
...
# }
# 
# shiny::shinyApp(onStart = start.func, ui = ui, server = server)